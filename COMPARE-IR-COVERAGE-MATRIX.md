...
| Stage 2 | `16`, `17`, `18` | `compare-ir-compiler-v1-stage2.cmd` | 3 bewusst gewaehlt enrichment samples, 3 matching, 0 mismatching, 0 skipped |
...
| Records | `02_records_functions`, `08_cross_module_type_composition`, `09_result_record_type_composition`, `10_result_record_contract_demo`, `11_result_array_record_payload`, `12_qualified_name_conflicts`, `15_result_abort_array_runtime_builtins`, `16_abort_propagation_runtime_log`, `17_record_mutation_runtime_log` | `RecordTypeDecl`, `RecordDef`, `RecordFieldDef`, `RecordLiteralExpr`, `FieldAccessExpr`, `TypeName` | Deckt lokale Records, importierte Records, verschachtelte Records und gleichnamige Records aus getrennten Modulen ab. |
...
| --- | --- | --- |
| Generics in Compare-IR | Stage-1 skipped `unsupported_generic_function` | Future Stage-2/Stage-3 slice after Generics strategy decision. |
| Async / Scope runtime | Stage-1 skipped `unsupported_async_scope_runtime`; grammar/AST has `ScopeStmt` | Runtime semantics and Go codegen path before positive IR sample. |
| gRPC bindings | Stage-1 skipped `unsupported_grpc_binding`; `ServiceDecl`/`RpcDecl` syntax exists | Align IDL/binding semantics before Compare-IR positive sample. |
