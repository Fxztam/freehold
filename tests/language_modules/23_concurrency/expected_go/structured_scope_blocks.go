...
package concurrency_structuredscopeblocks
...
func LoadInvoice(ctx context.Context, id int64) Invoice {
	return Invoice{Id: id}
}

func LoadCustomer(ctx context.Context, id int64) Customer {
	return Customer{Id: id}
}

func RenderInvoice(invoice Invoice, customer Customer) int64 {
	return invoice.Id + customer.Id
}

func Handle(ctx context.Context, id int64) int64 {
	{
		requestScope := FreeholdScope{}
		requestScope.ctx, requestScope.cancel = context.WithCancel(ctx)
		requestScope.priority = 3
		requestScope.sem = nil
		defer requestScope.cancel()
		_ = requestScope
