...
package concurrency_awaitchannelsendreceive
...
func Exchange(ctx context.Context, sender FreeholdSender[int64], receiver FreeholdReceiver[int64]) int64 {
	var sent bool = freeholdChannelSend[int64](sender, 42)
	if !(sent == true) {
		panic("freehold check failed")
	}
	var item int64 = freeholdChannelReceive[int64](receiver)
	return item
}
