...
| Go Compiler | `OPEN-GO-COMPILER.md` | Compiler V1 Start-Slice plus Import-, Result-, Abort-, Multi-File-, Runtime-Builtin- und Go-Projekt-Build-Slices implementiert: `go-codegen`, `go-codegen-project`, JSON-Spiegel, Golden-Faelle, Artefakt-Gate, import-aware Package-Calls, Result-Wertreturns, Abort-Error-Returns, Math/Std.IO/String/Json.stringify Runtime-Imports, `go.mod`/`build.cmd` fuer generierte Projekte sowie Zwei-Package-Projektgoldens fuer `App.Main`/`Banking.Proofs`. |
