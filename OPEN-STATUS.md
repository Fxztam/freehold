...
| Go Compiler | `OPEN-GO-COMPILER.md` | Compiler V1 Start-Slice plus Import-, Result-, Abort-, Multi-File-, Runtime-Builtin- und Go-Projekt-Build-Slices implementiert: `go-codegen`, `go-codegen-project`, JSON-Spiegel, Golden-Faelle, Artefakt-Gate, import-aware Package-Calls, Result-Wertreturns, Abort-Error-Returns, Math/Std.IO/String/Json.stringify Runtime-Imports sowie `go.mod`/`build.cmd` fuer generierte Projekte. |
...
OK:    274
FAIL:  45
Go codegen artifacts: 47/47 matching
AST shape:     274/274
