...
| Go Compiler | `OPEN-GO-COMPILER.md` | Compiler V1 Start-Slice plus Import-, Cross-Module-Call-, Result-, Abort-, Multi-File-, Runtime-Builtin-, BigNumber-, Go-Projekt-Build- und Feature-Matrix-Slices implementiert: `go-codegen`, `go-codegen-project`, JSON-Spiegel, Golden-Faelle, Artefakt-Gate, import-aware Package-Calls, importierte Freehold-Routinen via `exposing` und qualifizierte Modulnamen, Result-Wertreturns, Abort-Error-Returns, Math/Std.IO/String/Json.stringify/Big Runtime-Imports, `go.mod`/`build.cmd` fuer generierte Projekte, Zwei-Package-Projektgoldens fuer `App.Main`/`Banking.Proofs` sowie 24/24 Go-Codegen-Feature-Matrix-Abdeckung. |
...
OK:    274
FAIL:  45
Go codegen artifacts: 56/56 matching
Go feature matrix: 24/24 modules covered; supported 14, rejected 3, deferred 7
AST shape:     274/274
