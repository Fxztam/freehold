...
| Go Compiler | `OPEN-GO-COMPILER.md` | Compiler V1 Start-Slice plus Import- und Result-Slices implementiert: `go-codegen`, `--verify`, JSON-Spiegel, Golden-Faelle, Artefakt-Gate, import-aware Package-Calls und Result-Wertreturns. |
...
OK:    274
FAIL:  45
Go codegen artifacts: 29/29 matching
AST shape:     274/274
