...
1. `parse_mini_module_result` ergaenzen, damit der Parser direkt `ParseResult` liefert.
2. Danach einen negativen Parser-Fixture-Fall fuer `module Demo` / `end Other` ergaenzen.
