...
- Naechster Fokus vor echten deferred Features: policy-only/rejected V1-Pfade beweisen, damit V1 diese Pfade bewusst ablehnt und nicht halb uebersetzt. `12_type_conflicts` hat Go-Codegen-Rejection-Cases fuer alle negativen Konflikt-Fixtures; naechste Kandidaten: `13_contract_blocks`, `22_generics`.
