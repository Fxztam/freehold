...
- Danach kleine deferred Codegen-Slices: `11_errors_results` Result-value-field-access ist fuer V1 abgedeckt; offen bleiben `18_string_templates` dynamische Formatargumente und `04_types` breitere User-Type-Alias-Kombinationen.
