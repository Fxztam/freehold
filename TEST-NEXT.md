...
- Naechster Fokus vor echten deferred Features: policy-only/rejected V1-Pfade beweisen, damit V1 diese Pfade bewusst ablehnt und nicht halb uebersetzt. Kandidaten: `12_type_conflicts`, `13_contract_blocks`, `22_generics`.
